...
; Date of completed work: 26/11/2023
;
; **********************************
...
polling_loop:
	...
	lds r23, BUTTON_IS_PRESSED ; if a value other than zero is in BUTTON_IS_PRESSED, then button is pressed and '*' is displayed 
	tst r23					  ; this tests the register 23 and if not equal to 0, '*' is displayed
	brne star_on							   
	...
	rjmp polling_loop ; return to the start of the polling loop
...
check:             
	...
	ldi r16, low(900) ; this ultimately checks the ADC value and if it matches, no button is pressed 
	mov BOUNDARY_L, r16
	ldi r16, high(900)
	mov BOUNDARY_H, r16

		
	lds r16, ADCSRA ;this reads the button is pressed or not
	lds DATAL, ADCL
	lds DATAH, ADCH
